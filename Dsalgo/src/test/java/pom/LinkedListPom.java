...
public class LinkedListPom extends BaseClass {
	...
	@FindBy(xpath="//a[text()='Try here>>>']")///html/body/div[2]/div/div[2]/a
	WebElement Tryhere;
	...
	public void clickTextAreaSendCodeRun() {
		...
		//WebElement textarea=wait.until(ExpectedConditions.elementToBeSelected(By.className(CodeMirror-scroll);
